...
class LinkedInAccount(Base):
    ...
    authType = Column(String, default="OAUTH2")
    authStatus = Column(String, default="NOT_CONNECTED", index=True)  # NOT_CONNECTED | CONNECTED | AUTHORIZATION_EXPIRED | ERROR
    encryptedAccessToken = Column(Text, nullable=True)
    encryptedRefreshToken = Column(Text, nullable=True)
    tokenExpiresAt = Column(DateTime, nullable=True)
    tokenScope = Column(String, nullable=True)
    avatarUrl = Column(String, nullable=True)
    oauthState = Column(String, nullable=True)
